            ...
            >
                <div className="pr-2 md:mb-14 py-14 md:py-0">
                    <h1 className="text-3xl font-semibold text-blue-900 xl:text-5xl lg:text-3xl">
                        <span className="block w-full">Stay Updated with Latest Headlines</span> from around the world!
                    </h1>
                    <p className="py-4 text-lg text-gray-500 2xl:py-8 md:py-6 2xl:pr-5">
                        Breaking news, in-depth reports, and expert analysis to keep you informed on global events as they happen.
                    </p>
                    <div className="mt-4">
                        <a
                            href="#contact"
